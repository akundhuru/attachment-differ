...
and an LLM) both flip malicious$\rightarrow$benign on 31.6\% of extractor pairs
...
\begin{enumerate}
  ...
  modern content detector's verdict---including an LLM detector.
...
reproducible) and an LLM detector (structured-output verdict; the exact model and
snapshot version are pinned in \code{README.md}). An
...
including an LLM (31.6\% of extractor pairs on image-masking vectors), and showed
