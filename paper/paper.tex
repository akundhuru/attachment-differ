...
attachment loader. From the Apache SpamAssassin public corpus we process the spam
sets ($\approx$2{,}400 messages), yielding 31 attachments; they are overwhelmingly
image/HTML---document attachments are rare---itself a finding about where
document-parser evasion lives. For a document-rich sample
...
reproducible) and an LLM detector (structured-output verdict). An
